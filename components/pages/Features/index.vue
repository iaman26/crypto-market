<template>
  <FeaturesPriceCrypto />
  <div class="flex">
    <div class="flex w-full flex-col-reverse items-center 2xl:flex-row">
      <FeaturesOrderbook />
      <div class="mx-6 w-full">
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            <div
              class="mr-4 flex rounded-[15px] border border-gray-800 p-[6px]"
            >
              <div
                class="rounded-[10px] bg-gray-800 px-4 py-2 text-[10px] font-normal"
              >
                Candle Line
              </div>
              <div
                class="rounded-[10px] px-4 py-2 text-[10px] font-normal text-zinc-400"
              >
                Depth
              </div>
            </div>
            <div class="mr-4 w-6">
              <UIcon name="IconSettings" dynamic filled />
            </div>
            <div class="mr-4 w-6">
              <UIcon name="IconCameraIcon" dynamic filled />
            </div>
            <div class="mr-4 w-6">
              <UIcon name="IconZoomIcon" dynamic filled />
            </div>
          </div>
          <div class="mt-[11px] flex pr-[20px] xs:mt-0">
            <button
              :id="TimeChart === 1 ? 'main' : ''"
    ...
    <FeaturesTransactionCrypto />
  </div>
  <FeaturesListTransaction :listTransaction="listTransaction" />
</template>
<script setup>
...
const onViewChart = ref(false)

onMounted(() => {
  setTimeout(() => {
    onViewChart.value = true
  }, 500)
})
</script>
<style scoped>
